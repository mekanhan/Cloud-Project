...
public class CommonStepDefs {
    ...
    public void iLogin() throws Exception {
        ...
        WebElement permissions = (WebElement) WebElementMgr.getWebElement(context.getPageObjectMgr().getCurrentPage(), "permissions");
        WebElement buffSciButton = (WebElement) WebElementMgr.getWebElement(context.getPageObjectMgr().getCurrentPage(), "buffSciButton");
