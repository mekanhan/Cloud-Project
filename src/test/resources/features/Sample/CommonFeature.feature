Feature: validate using common step definitions
  ...
  Scenario: for home page
    ...
    Then I validate homeImg src is "https://process.fs.teachablecdn.com/ADNupMnWyR7kCWRvm76Laz/resize=height:60/https://www.filepicker.io/api/file/WSundQ6BT6u2OZe2kcNA"
  ...
  Scenario: for practice page wait
    ...
    When I click on practiceBtn
    Then I am on the PracticePage page
    Then I wait for enterNm to be visible
