package PageFactory.Sample;//package PageFactory.Sample;
...
//
//    @FindBy (how= How.CSS,using = "a[href='https://hr-testing.buffsci.org/staff-positions']")
...
//
//    @FindBy(how=How.XPATH,using = "//input[@type='search']")
//    public static WebElement positionTypeSearchBox;
//
//    @FindBy(how=How.XPATH,using = "//div[@id='DataTables_Table_0_paginate']/ul/li")
//    public static List<WebElement> positionTypeTableResultPage;
//
//    @FindBy(how=How.CSS,using = "#DataTables_Table_0_next")
//    public static WebElement latest;
//
//    @FindBy(how=How.CSS,using = "select[name='DataTables_Table_0_length']")
//    public static WebElement positionTypePageResultDropDown;
//
//    @FindBy(how=How.CSS,using = "li[class='paginate_button page-item next disabled']")
//    public static WebElement resultPagesNextButton;
//
//
//
//
